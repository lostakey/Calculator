...
public:
    ...
    virtual double evaluate(PluginManager* pluginManager) const = 0;
};
...
public:
    ...
    double evaluate(PluginManager* pluginManager) const override { return m_value; }
};
...
public:
    ...
    double evaluate(PluginManager* pluginManager) const override;
};
